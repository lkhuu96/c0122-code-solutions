...
export default class App extends React.Component {
    ...
    */
    ...
    fetch('/api/todos', {
      ...
      .then(data => {
        ...
        const newTodos = oldTodos.concat([data]);
        this.setState({
          todos: newTodos
        });
      })
  ...
  toggleCompleted(todoId) {
    ...
    const todoCompletedStatus = todos[index].isCompleted;
    const todoOpposite = {
      isCompleted: !todoCompletedStatus
    };
    fetch(`/api/todos/${todoId}`, {
      ...
      body: JSON.stringify(todoOpposite)
    })
      .then(res => res.json())
      .then(data => {
        const newTodo = [];
